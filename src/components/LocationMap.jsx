...
export default function LocationMap({ lang }) {
  const weeklyTimings = [
    { day: lang === 'en' ? 'Monday - Saturday' : 'پیر - ہفتہ', hours: '10:00 AM - 9:00 PM', status: 'Open' },
    { day: lang === 'en' ? 'Sunday' : 'اتوار', hours: 'Emergency Only', status: 'On Call' }
  ];
    ...
    <section id="location" className="location-section">
      <div className="container">
        ...
        <div className="location-grid">
          ...
          {/* Right Column: Google Maps Embed with Top-Left Info Box & Bottom Hotline Box */}
          <div className="location-map-col glass-card">
            <div className="map-frame-wrapper">
              ...
              {/* TOP-LEFT Google Maps Info Card Overlay (As requested by user) */}
              <div className="map-top-left-card glass-card">
                ...
                <p className="map-card-desc">
                  {lang === 'en' 
                    ? 'Premier Advanced Dental Care & Esthetics • Dr. Aleena Usman (BDS, Gold Medalist)' 
                ...
                >
                  <Navigation size={14} />
                  <span>{lang === 'en' ? 'Directions' : 'راستہ'}</span>
                </a>
              </div>

              {/* Floating Emergency Hotline Overlay Box */}
              <div className="hotline-overlay-box glass-card">
                ...
                <div className="hotline-text-group">
                  <span className="hotline-label">{lang === 'en' ? '24/7 Dental Emergency' : 'ایمرجنسی ڈینٹل ہیلپ لائن'}</span>
